...
public class Isopod : MonoBehaviour
{
    ...
    public GameObject BagianIsopod;
    public GameObject BagianTanah;
    private Animator isopodAnimator;
    private Animator tanahAnimator;
    private Collider2D isopodCollider;
    ...
    void Start()
    {
        ...
        isopodAnimator = BagianIsopod.GetComponent<Animator>();
        tanahAnimator = BagianTanah.GetComponent<Animator>();
        isopodCollider = GetComponent<Collider2D>();
    ...
    public void IsopodMasuk()
    {
        Destroy(gameObject);
    }

    public void IsopodKeluar()
    {
        canClick = true;
        isopodCollider.enabled = true;
    }


    void digUp()
    {
        isopodAnimator.SetTrigger("Keluar");
